...
public class TutorialUI : MonoBehaviour
{
    ...
    [SerializeField] private TextMeshProUGUI keyMoveAlternateText;
    ...
    private void UpdateVisual()
    {
        ...
        keyMoveAlternateText.text = GameInput.Instance.GetBindingText(GameInput.Binding.InteractAlternate);
